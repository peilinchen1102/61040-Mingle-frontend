...
<template>
  <form @submit.prevent="editPost(content)">
    ...
    <div class="base">
      <menu>
        <li><button class="btn-small button-4 pure-button-primary" type="submit">Save</button></li>
        <li><button class="btn-small button-4" @click="emit('editPost')">Cancel</button></li>
      </menu>
